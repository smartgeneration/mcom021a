...
# 5 tap mo cho bien ngon ngu nhiet do phong hien tai
...
def get_fan_speed_control_rules(): # Cac luat mo bieu dien toc do quat
    rule1a = ctrl.Rule(
...
def get_compressor_speed_control_rules(): # Cac luat mo bieu dien toc do may nén
    rule1a = ctrl.Rule(
        room_temperature['very-hot'] & temperature['very-cold'] & humidity['humid'],
